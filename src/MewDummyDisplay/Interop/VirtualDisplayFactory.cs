...
{
    // CIE xy chromaticities of the sRGB primaries and of D65 white. Chromaticities, where
    // x + y is at most one, and not the XYZ tristimulus values an ICC profile stores: macOS
    // builds the display's colour profile from these, and XYZ values read as xy put the
    // white point outside the visible gamut.
